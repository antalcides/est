...
\index{Técnicas de conteo@\selectlanguage{english}%
Técnicas de conteo\selectlanguage{spanish}%
...
\index{Diagrama de árbol@\selectlanguage{english}%
Diagrama de árbol\selectlanguage{spanish}%
...
\begin{defi}{}{}\index{Permutaciones@\selectlanguage{english}%
Permutaciones\selectlanguage{spanish}%
...
\index{Muestreo@\selectlanguage{english}%
Muestreo!Sin reemplazo@Sin reemplazo\selectlanguage{spanish}%
...
\index{Muestreo@\selectlanguage{english}%
Muestreo!Con reemplazo@Con reemplazo\selectlanguage{spanish}%
...
\index{Coeficiente multinomial@\selectlanguage{english}%
Coeficiente multinomial\selectlanguage{spanish}%
...
\index{Combinación@\selectlanguage{english}%
Combinación\selectlanguage{spanish}%
...
\begin{defi}{}{}\index{Probabilidad@\selectlanguage{english}%
Probabilidad!condicionada@condicionada\selectlanguage{spanish}%
...
\begin{ejemplo}[]\index{Eventos@\selectlanguage{english}%
Eventos!Independencia@Independencia\selectlanguage{spanish}%
...
\index{Reglas multiplicativas@\selectlanguage{english}%
Reglas multiplicativas\selectlanguage{spanish}%
}
...
\end{defi}
\begin{figure}[ptbh]
\centering{}\includegraphics[scale=0.4]{48_media_antalcides_Antalcides-EXT1_est_bak_est_pdf_Image1.pdf}\caption{\selectlanguage{english}%
$A_{1},A_{2},A_{3},A_{4}$ y $A_{5}$ forman un sistema exhaustivo
y excluyente de sucesos\selectlanguage{spanish}%
}
\label{fig 3.5}
\end{figure}
...
\begin{figure}[ptbh]
\centering{}\includegraphics[scale=0.4]{49_media_antalcides_Antalcides-EXT1_est_bak_est_pdf_particion.pdf}\caption{\selectlanguage{english}%
...
las cantidades $P\left(B\cap A_{i}\right)$\selectlanguage{spanish}%
}
\label{fig 3.6}
\end{figure}
...
un sistema exhaustivo y excluyente de eventos. \index{Teorema@\selectlanguage{english}%
Teorema!Bayes@Bayes\selectlanguage{spanish}%
