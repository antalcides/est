...
$(document).ready(function()  {
	...
	$('#'+dialog_id).load(data_url+'?referer='+window.location.href, function() {		
		dialog.closest(".ui-dialog").find(".ui-dialog-title").append('<div class="ui-dialog-subtitle"><span class="ui-dialog-stats"></span> | <span class="clear-selection link">Limpiar selección</span></div>');
	});
	...
	function dialog_update_stats(dialog){
		...
		dialog.find(".ui-dialog-stats").html(selected + ' seleccionados');
	}
