...
\draw[thick] \rectangulo node [below left of=c2, yshift=2.0cm, xshift=2.5cm]  {$U$};     \end{tikzpicture} 
...
%\node at ($0.33*(A)+0.33*(B)+0.33*(C)$){Text M};
\end{tikzpicture}
\begin{venndiagram2sets}[labelU={S},shadeA=red!80,shadeB=red!80,shadeAB=gray,tikzoptions={scale=0.8,thick}]
\fillACapB
\fillA
\fillB
